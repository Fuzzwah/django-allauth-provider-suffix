...
if "allauth.socialaccount.providers.openid_provider" not in settings.INSTALLED_APPS:
    raise ImproperlyConfigured(
        "The steam provider requires 'allauth.socialaccount.providers.openid_provider' to be installed"
    )
